...
public class EventReadDto {
    ...
    public EventReadDto(UUID uuid, String title, String description, LocalDateTime dtEvent, LocalDateTime dtEndOfSale, EventType type, EventStatus status, LocalDateTime createdAt, LocalDateTime modifiedAt, String createdBy, String modifiedBy, Integer version) {
        this.uuid = uuid;
        this.title = title;
