...
@Component
public class UserCreateUpdateValidator implements IValidator<UserCreateUpdateDTO> {
    private final List<ErrorMessage> errorMessages = new ArrayList<>();

    private final ProjectDetails projectDetails;

    public UserCreateUpdateValidator(ProjectDetails projectDetails) {
        this.projectDetails = projectDetails;
    }


    @Override
    public boolean isValid(UserCreateUpdateDTO object) {
