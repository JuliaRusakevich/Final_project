package com.gmail.juliarusakevich.event.controller.filter;

import com.gmail.juliarusakevich.event.controller.utils.JwtTokenUtil;
       ...
       2. сходить с полученным токеном на user-service с помощью http
        ...
        UserDetails userDetails = new UserDetails() {
            ...
            public boolean isEnabled() {
                return JwtTokenUtil.getInfoAboutEnabledAccount(token);
            }
        };
