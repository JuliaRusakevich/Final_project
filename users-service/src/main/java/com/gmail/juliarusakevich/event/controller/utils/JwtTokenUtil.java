package com.gmail.juliarusakevich.event.controller.utils;
...
public class JwtTokenUtil {
    ...
    public static String generateAccessToken(UserDetails user) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis()
                                        + TimeUnit.DAYS.toMillis(7))) // 1 week
    ...
    public static boolean getInfoAboutEnabledAccount(String token) {
        Claims claims = Jwts.parser()
                .setSigningKey(jwtSecret)
                .parseClaimsJws(token)
                .getBody();
